        ...
        <div class="col-span-9 grid md:grid-cols-3 gap-4 mt-6 lg:mt-0 ">
            ...
            <div class="shadow rounded bg-gray-100 px-4 pt-6 pb-8">
                <div class="flex justify-between items-center mb-4 ">
                    <h3 class="text-2xl font-medium capitalize mb-6 mt-6">Personal Profile </h3>
                    <a href="address.html" class="text-primary">Edit</a>
                </div>
                <div class="space-y-1">
                    <h3 class="text-gray-700 font-medium"><?php echo $row['username']; ?></h3>
                    <p class="" text-gray-800><?php echo $row['email']; ?></p>
                    <p class="" text-gray-800><?php echo $row['phone_no']; ?></p>
                </div>
            </div>
            <!-- ----End single card --->
            ...
            <div class="shadow rounded bg-gray-100 px-4 pt-6 pb-8">
                <div class="flex justify-between items-center mb-4 ">
                    <h3 class="text-2xl font-medium capitalize mb-6 mt-6">Shipping Address </h3>
                    <a href="address.html" class="text-primary">Edit</a>
                </div>
                <div class="space-y-1">
                   
                    <p class="" text-gray-800><?php echo $row['address']; ?></p>
