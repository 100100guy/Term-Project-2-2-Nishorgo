...
<div class="col-span-9 shadow rounded px-6 bg-gray-100 pt-5 pb-7 mt-6 lg:mt-0 ">
        <form method="post" action="UserUpdatePassword.php" >
          <h3 class="text-2xl font-medium capitalize mb-6 mt-6">Change Password</h3>
          
<div class="space-y-4 max-w-lg ">
     <div class=" ">
               <!-- ----Single Input --->
          <!-- <div>
               <label class="text-gray-800 mb-2 block text-xl" >Current Password </label>
               <div class="relative">
                    <span class="absolute right-3 top-3 text-sm text-gray-500 cursor-pointer ">
                         <i class="far fa-eye-slash"></i>
                    </span>
                    <input type="password" name="currpassword" class="input-box" placeholder="Enter current password" />
               ...
               <!-- ----End Single Input --->
                 ...
                 <!-- ----Single Input --->
          <div>
               <label class="text-gray-800 mb-2 mt-2 block text-xl" >New Password </label>
               <div class="relative">
                    <span class="absolute right-3 top-3 text-sm text-gray-500 cursor-pointer ">
                         <i class="far fa-eye-slash"></i>
                    </span>
                    <input type="password" name="newpassword"class="input-box" placeholder="Enter new password" />
...
<div class="mt-6">
     <button type="submit" class="px-6 py-2 text-center text-white bg-primary rounded hover:bg-transparent hover:text-primary transition uppercase font-medium mb-6 mt-6" >Save Change </button>
</div>
