...
<html lang="en">
  ...
  <head>
    ...
    <title>Nishorgo | All Blogs</title>
  ...
  <body>
    ...
    <header class="header">
        ...
        <a href="index.html" class="logo"> <i class="fas fa-solid fa-leaf"></i> Nishorgo </a>
                     ...
                     if(mysqli_connect_errno()){
                      echo 'could not connect to server.';
                        ...
                        if($productShow == "all"){
                            ...
                            $sql = "SELECT * FROM blog WHERE tag = 'vegetable';";
                        } else if($productShow == "fruit"){
                            $sql = "SELECT * FROM blog WHERE tag = 'fruit';";
                        } else if($productShow == "flower"){
                            $sql = "SELECT * FROM blog WHERE tag = 'flower';";
                        } 
                ...
                <div class="col-lg-6">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      ...
                      <p><?php echo $row['blog_header'];?></p>
                      <div class="post-options">
                        <div class="row">
                          <div class="col-lg-12">
                            <ul class="post-tags">
                              <li><i class="fa fa-tags"></i></li>
                              <li><p><?php echo $row['tag']?>
                            </ul>
                          </div>
                        </div>
                      </div>
